...
class QualityTable:
    ...
    def init(self, path):
        ...
        text = [
            ...
            "Isolerade grön- eller blåytor som inte uppfyller kraven i K6/K7. Även dessa områden kännetecknas av naturliga och självreglerande processer och kan ofta utvecklas mot högre biodiversitet.",
            "Gäller endast nyskapade eller tillförda objekt som särskilt gynnar biologisk mångfald. Åtgärder behöver förankras hos ekolog för att säkersälla att de kommer ha positiv effekt på den biologiska mångfalden. Om befintliga träd tas ned men lämnas som död ved eller högstubbar får även detta räknas. 15/25/50 kvm/st",
            "Upphöjd mark med vegetation, i första hand placerad nära bullerkällan. Ska bestå av poröst material med potential att dämpa buller, exempelvis jord. Bullervallens yta räknas.",
            "Vegetationsklädd mark placerad i markplan mellan bullerkällan och mottagaren. Marken måste vara porös för att få tillgodoräknas. Vid armerad vegetation räknas hälften av ytan (vegetation i fogar räknas ej).",
            "Grönyta med flera trädrader som placeras mellan bullerkällan och mottagaren på sådan höjd att siktlinjen skärmas. Det ska ej vara möjligt att se igenom vägridån, den ska dölja bullerkällan.",
            "Träden ska placeras utan stora glipor mellan trädens kronor. Om träden placeras i hårdgjord mark bör de planteras i skelettjord eller motsvarande. Om träden får bra förutsättningar ökar storleken på trädens kronor. Ibland kan dubbla trädrader vara en lösning för att få till en bra krontäckning. Om detta görs, räknas bara en rad.",
            "Substratytan där växtligheten i vertikala ytor kan växa får räknas. Substratet skall vara tjockt och poröst. Kan vara gröna tak, väggar eller fristående skärmar. För att få tillgodoräkna poängen måste följande kriterier uppfyllas för respektive kategori:<br>Gröna tak - 10 cm<substrat. Bullret hos mottagaren ska vara dominerat av bidrag som kommit över de gröna taken.<br>Gröna väggar - 20 cm<substrat / 10 cm<substrat + 10 cm luftspalt mot fasad. Kassetter med substrat kan monteras med avstånd till fasad, utan förändrad akustisk effekt. För klängväxter som inte behöver substrat, kan i stället en akustisk absorbent användas (tillexempel mineralull).<br>Fristående bullerskärmar - 20 cm<bred. Det är även viktigt att skärmen har en hård kärna så att ljud inte passerar igenom skärmen.",
            "Den yta som täcks av vegetation direkt eller senast inom loppet av 5 år räknas. Klätterväxter på bullerplank, fasad, pergola mm",
            "Objekt och föremål som maskerar oönskat ljud, bidrar till rofylldhet och bättre ljudmiljö. Får endast räknas där det positiva ljudet har potential att överrösta det negativa bullret. I mycket bullriga miljöer bidrar inte positiva ljud till rofyllda miljöer. Var gränsen går för när det är för bullrigt varierar.  50 dBA är en nivå som rapporterats för stadsparker. Men även vid högre nivåer kan positiva ljud ibland ha önskad effekt. 25/kvm st.",
            "Vattenytor och vattenstråk som renar och fördröjer dagvatten. Träd som ingår i ytorna räknas in här (räknas ej separat). Hårdgjorda ytor räknas ej. Vattnet ska vara så pass rent att det inte påverkar det akvatiska ekosystemet negativt.",
            "Naturytor med låg avrinning men hög genomsläpplighet (avrinningskofficient max 0,1). Exempelvis ett skogsområde som minskar avrinning mot ett bostadsområde. Den samlar inte upp dagvatten men tar hand om merparten av det regn som faller på den.",
            "Ytor och stråk i lågpunkter som fungerar som tillfälliga översvämningsytor vid kraftiga regn.  Träd som ingår i ytorna räknas in här (räknas ej separat). Hårdgjorda ytor räknas ej.",
            "Anlagda ytor så som regnbäddar, växtbäddar, växtbäddar på bjälklag, gröna tak, m.m. som är särskilt utformade för dagvattenhantering med flera olika vegetationsskikt räknas. Avrinningsytan som anläggningen tar hand om räknas. Hårdgjorda ytor räknas ej.",
            "Enstaka träd i skelettjord särskilt anlagda för dagvattenhantering. Avrinningsytan som anläggningen tar hand om räknas. Skelettjordar med relativt stor porvolym har en magasinerande förmåga, medan träd har en förmåga att ta upp och transpirera vatten och fördröja dagvatten i lövverket. Omkringliggande ytor planeras så att dagvatten ifrån dessa tillrinner ytan på ett för trädet optimalt sätt (hänsyn till vattenkrav och tålighet).",
            "Dagvatten som samlats upp i magasin eller tunna för bevattning av omgivande grönska. Gäller endast särskilt utformade bevattningssystem. 25 kvm/st",
            "Vegetationsytor av såväl torrare eller fuktigare karaktär med minst tre vegetationsskikt (fältskikt, buskskikt och trädskikt).  Flerskiktad vegetation ger upphov till både evapotranspiration och skuggning , vilket ger god temperaturreglerande förmåga. Ger stor kyleffekt dagtid och kan vara 4–5 grader svalare än omgivande bebyggelse.",
            "Vegetationsytor av halvöppen karktär (fältskikt och antingen buskskikt eller trädskikt). Ger upphov till evapotranspiration och skuggning men är mindre effektiv än K22.",
            "Öppna grönytor med en låg andel eller avsaknad av träd.",
            "Grönska placerad på så sätt att den har potential att skugga soliga lägen. Räkna den yta som beräknas vara täckt av växtlighet inom loppet av 5 år. Grönska på konstruktioner ger skugga och minskar strålningstemperaturen från hårdgjorda ytor. Grönska på byggnader som ingår i kvartersmark ska inte räknas eftersom de räknas i GYF Kvarter.",
            "Träd med potential att skugga soliga lägen räknas. 25 kvm/st. Skuggande träd på hårdgjorda ytor till exempel gatuträd har stor inverkan på minskandet av strålningstemperaturen. Den upplevda temperaturen kan vara upp till 14 grader svalare under ett träd. Gaturummet bör utformas på ett sätt som tillåter grönska att ta plats utan att riskera ansamling av luftföroreningar pga. förhindrad vertikal luftomblandning.",
            "Yta som innehåller alla resurser som pollinatörer behöver för hela sin livscykel, det vill säga både boplatser, parningshabitat, värdväxter, övervintringsplatser och födoresurser över hela säsongen (april–oktober för bin). En pollinatörsnod kan även utgöra flera, utspridda ytor inom det avgränsade området vilka tillsammans bidrar med de tre olika resurstyperna, men ytorna behöver då vara sammanlänkade. En pollinatörsnod måste totalt vara minst 100 kvm för att få räknas. Rätt typ av förvaltning krävs för att säkerställa resurserna.",
            ...
            "Enstaka, särskilt viktiga element för pollinatörer i form av föda eller bon för bin, som inte ingår i K 27-K28. Träd och buskar som uppfyller 3/3 på nektar- och pollenlistan samt boplatser får räknas här. 25 kvm/st",
            ...
            "Skogsdungar och skogsområden, minst 200x200 meter, men helst större, gärna uppemot 5 ha. De kan utgöras av både artrik natur eller mer ordinär skogsmiljö, så kallad vardagsnatur. Ytan kan innehålla både lättillgängliga mer ordnade delar och mer orörda delar.",
            "Stadsrum som kännetecknas av grönska och som visuellt ger intryck av en grön stadsbild. Både befintliga och nyanlagda ytor får räknas. Ska vara tillgängliga för människor men vara tillräckligt stora i relation till antal nyttjare så att slitage och trängsel undviks och ytans värde bibehålls.",
            "Gröna miljöer utpekade i kulturmiljöprogram eller liknande. De ska vara av kulturhistoriskt värde, ha betydelse för att förstå områdets historia och/eller av stor betydelse för områdets identitet. Ska vara tillgängliga för människor men på så sätt att slitage undviks och ytans värde bibehålls.",
            "Här räknas enskilda bevarade natur- och kulturobjekt som utpekats som särskilt värdefulla i natur- och kulturutredningar, landskapsanalyser eller liknande och som inte står inom yta annan kulturell-yta. Väcker fantasi och mystik, värdefulla för lärande m.m. 25 kvm/st",
            "Grönska och naturobjekt av betydelse för stadsbild och upplevelsen av stadsmiljön. Träd som tillför viktiga visuella stadsbildskvalitéer, upplevelser och årstidsväxlingar. Hit räknas även exotiska blommande träd in. 25 kvm/st",
            "Varierad nyanlagd artrik park eller naturmark. Motsvarar ofta K6/K7. För att få räknas krävs att området kan nyttjas för rekreation (promenader och lugn vistelse), lärande m.m. Ska vara tillgängliga för människor men vara tillräckligt stora i relation till antal nyttjare så att slitage och trängsel undviks.",
            "Avser ytor med rik blomning. Avser både befintliga och nyanlagda ytor förutsatt att de är blomrika och sköts på ändamålsenligt sätt. Endast den faktisk blommande yta räknas. Vertikala ytor får räknas. Träd räknas i kvalitet K36 eller K37. Ska vara tillgängliga för människor men vara tillräckligt stora i relation till antal nyttjare så att slitage och trängsel undviks.",
            ...
            "Natur- och parkytor iordningställda för skilda aktiviteter. Natur- och parkytorna ska vara tillräckligt stora i relation till antal nyttjare så att  slitage och trängsel undviks. Ryms ﬂera aktiviteter inom en yta får dessa räknas förutsatt att aktiviteterna inte stör eller motverkar varandra. Ytor med konstgräs och gummiytor får inte räknas.",
