...
class QualityTable:
    ...
    def init(self, path):
        ...
        text = [
            ...
            "Gäller endast bevarade objekt som bevarats i sitt ursprungliga läge.<br><br><b>50 kvm/st:</b> Stora gamla träd (>80 cm diameter)<br><b>25 kvm/st:</b> hålträd, bärande träd<br><b>15 kvm/st:</b> högstubbar, buskar, tätt buskage/fågelsnår, död ved (större träd, lågor eller stammar)",
            ...
            "Träden ska placeras utan stora glipor mellan trädens kronor.<br><br>Om träden placeras i hårdgjord mark bör de planteras i skelettjord eller motsvarande.Om träden får bra förutsättningar ökar storleken på trädens kronor. Ibland kan dubbla trädrader vara en lösning för att få till en bra krontäckning. Om detta görs, räknas bara en rad.",
            "Substratytan där växtligheten i vertikala ytor kan växa får räknas. Substratet skall vara tjockt och poröst. Kan vara gröna tak, väggar eller fristående skärmar.<br><br>För att få tillgodoräkna poängen måste följande kriterier uppfyllas för respektive kategori:<br><br>Gröna tak - 10 cm substrat. Bullret hos mottagaren ska vara dominerat av bidrag som kommit över de gröna taken.<br><br>Gröna väggar - 20 cm substrat / 10 cm substrat + 10 cm luftspalt mot fasad. Kassetter med substrat kan monteras med avstånd till fasad, utan förändrad akustisk effekt. För klängväxter som inte behöver substrat, kan i stället en akustisk absorbent användas (tillexempel mineralull).<br><br>Fristående bullerskärmar - 20 cm bred. Det är även viktigt att skärmen har en hård kärna så att ljud inte passerar igenom skärmen.",
        ...
        q_f = [
            ...
            [2, 'K13', 0.5, 'Trädbälte 15m&#60bred', 'Trädbälte 15m<bred', text[12]],
